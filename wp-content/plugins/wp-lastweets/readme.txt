...
You can override the custom default theme template to display a tweet by copying the `/templates/single_tweet.php` file and pasting it in your theme `/templates/wp-lastweets-single_tweet.php` folder. 
...
See also the list of [contributors](https://github.com/psaikali/wp-lastweets/graphs/contributors) who participated in this project.

== Installation ==

After installing and activating the plugin, heads to the `Settings > wp-lastweets` options page.
